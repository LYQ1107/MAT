...
- 研究分支 `research/longitudinal-mat` 当前本地/远端 SHA：`8847512c34dff7fd962d28bf599091220be80fd5`（`git ls-remote origin refs/heads/research/longitudinal-mat` 已核对）；main 保留安全基线 `78e7ae4`。
